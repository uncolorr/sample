...
class TakeObjectCodeHandler : CodeHandler, StepHandler {
    ...
    override fun prepare() {
        ...
        baseParams[Fields.PackingTasks.PROCESS_TOKEN] = ProcessToken.TAKE_OBJECT.value
        baseParams[Fields.PackingTasks.PROCESS_NAME] = "Take object"
